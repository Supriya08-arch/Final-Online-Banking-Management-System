...
<body>
  ...
  <header id="header" class="fixed-top ">
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <a href="index.php" class="logo"><img src="assets/img/img.png" alt="" class="img-fluid"> &nbsp ASAP Bank</a>
    ...
    <div class="container-fluid" data-aos="fade-up">
      <div class="row justify-content-center">
        <div class="col-xl-5 col-lg-6 pt-3 pt-lg-0 order-2 order-lg-1 d-flex flex-column justify-content-center">
          <h1>The Better Way To Bank.</h1>
          <h2> Banking with Excellence </h2>
          <div class="heroBtn">
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-6 order-1 order-lg-2" data-aos="zoom-in" data-aos-delay="150">
            <img src="assets/img/step.png" class="img-fluid" alt="">
          </div>
          <div class="col-lg-6 pt-4 pt-lg-0 order-2 order-lg-1 content" data-aos="fade-right">
            <h3>Step's to Follow </h3>
            <p class="font-italic">
              You just need to follow the following steps to create an account.             </p>
            <ul>
              <li><i class="bi bi-check-circle"></i> Fill Your Basic Detail.</li>
              <li><i class="bi bi-check-circle"></i> Upload Your Document.</li>
    ...
    <section id="services" class="services section-bg">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          <h2>Services</h2>
          <p>Our customers receive the best baking services from us. For safe online banking, we use a secure and reliable server, and we offer a bank-to-bank transaction service.</p>
        </div>
        ...
        <div class="row gy-4">
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="100">
            <div class="icon-box iconbox-green">
              ...
              <p>The safety of our customers is our top priority.</p>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="200">
            <div class="icon-box iconbox-blue ">
              ...
              <p>With us, you can easily manage your credit and debit card activities.</p>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="300">
            <div class="icon-box iconbox-pink">
              ...
              <p>With the help of online banking, our customers may access their accounts at any time without having to visit a physical branch. </p>
            </div>
          </div>
          ...
          <!-- <div class="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="100">
            <div class="icon-box iconbox-yellow">
              ...
              <p>Secure your and your family’s future with our various plans and services</p>
            </div>
          </div> -->
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="200">
            <div class="icon-box iconbox-red">
              ...
              <p>Our team will be delighted to assist you at any time of day.</p>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="300">
            <div class="icon-box iconbox-teal">
              ...
              <p>Loans are accepted when you register online.</p>
            </div>
          </div>
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          ...
          <div class="image col-lg-6 order-1 order-lg-2 " data-aos="zoom-in" data-aos-delay="100">
            <img src="assets/img/fe.png" alt="" class="img-fluid">
          </div>
        </div>
          ...
          <div class="swiper-wrapper">
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                <p>
                  ...
                  ASAP Bank is the best bank for Monitoring account it provide data in graphical manner from that can we understand our account is in profit or loss. Also i use saving option which is wonderful.
                  <i class="bx bxs-quote-alt-right quote-icon-right"></i>
                </p>
                <img src="assets/img/testimonials/suman.jpg" class="testimonial-img" alt="">
                <h3>Suman Mainali</h3>
                <h4>Customer</h4>
              </div>
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                <p>
                  <i class="bx bxs-quote-alt-left quote-icon-left"></i>
                  The Transaction system of the ASAP bank is very fast. We can easily manage our transaction history.
                  with digramatical manner
                  <i class="bx bxs-quote-alt-right quote-icon-right"></i>
                </p>
                <img src="assets/img/testimonials/anu.jpg" class="testimonial-img" alt="">
                <h3>Anu Shivakoti</h3>
                <h4>Customer</h4>
              </div>
            </div><!-- End testimonial item -->
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                <p>
                  ...
                  and start your online banking and the loan intrest rate is acceptable. Thank You ASAP Bank!
                  <i class="bx bxs-quote-alt-right quote-icon-right"></i>
                </p>
                <img src="assets/img/testimonials/perisha.jpg" class="testimonial-img" alt="">
                <h3>Perisha Gole</h3>
                <h4>Customer</h4>
              </div>
            </div><!-- End testimonial item -->
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                ...
                <img src="assets/img/testimonials/supu.jpg" class="testimonial-img" alt="">
                <h3>Supriya Karki</h3>
                <h4>Customer</h4>
              </div>
            </div><!-- End testimonial item -->
          ...
          <ul>
            <li data-aos="fade-up" data-aos="fade-up" data-aos-delay="100">
              ...
              <div id="faq-list-1" class="collapse show" data-bs-parent=".faq-list">
                <p>
                You just need to follow the following steps to create an account. <br>
            ...
            <li data-aos="fade-up" data-aos-delay="200">
              <i class="bx bx-help-circle icon-help"></i> <a data-bs-toggle="collapse" data-bs-target="#faq-list-2" class="collapsed">What ate the documents required? <i class="bx bx-chevron-down icon-show"></i><i class="bx bx-chevron-up icon-close"></i></a>
            ...
            <li data-aos="fade-up" data-aos-delay="600">
              <i class="bx bx-help-circle icon-help"></i> <a data-bs-toggle="collapse" data-bs-target="#faq-list-5" class="collapsed">How to apply for Loan?<i class="bx bx-chevron-down icon-show"></i><i class="bx bx-chevron-up icon-close"></i></a>
              <div id="faq-list-5" class="collapse" data-bs-parent=".faq-list">
                <p>
                To Apply Loan follow the steps given below : <br>
                 1. Open Login Page <br>
                 2. Login to Account <br>
                 3. click on Loan menue <br>
                 4. Fill up Loan Application <br>
                </p>
              </div>
            </li>
    ...
    <div class="footer-top">
      <div class="container">
        <div class="row">
          ...
          <div class="ucfirst() col-md-6 footer-contact">
            <h3>ASAP Bank (As soon As Possible)</h3>
            <p>
              <!-- Sky Tower <br> -->
              Lalitpur<br>
              Nepal <br><br>
              <strong>Phone:</strong> 01-5544221<br>
              <strong>Email:</strong> asap@example.com<br>
            </p>
          </div>
          ...
          <div class="col-lg-4 col-md-6 footer-newsletter">
            <div class="d-flex justify-content-center">
              <img src="assets/img/img.png" style="width: 300px; height: 100px;" alt="">
            </div>

            <h1 class="text-center mt-2">ASAP Bank</h1>
          </div>
