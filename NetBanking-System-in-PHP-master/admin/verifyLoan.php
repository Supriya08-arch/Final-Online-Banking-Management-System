                ...
                <ul class="navbar-nav align-self-stretch">
                    ...
                    <li class="menuHover">
                        <a href="../admin/cards.php" class="nav-link text-left active" role="button">
                            <i class="flaticon-bar-chart-1"></i> <i class="bx bxs-credit-card ico"></i>Loan Requests <span class="badge badge-success" style="font-size: 12px; margin-left: 50px;"> <?php echo $debitNotify; ?> new</span>
                        </a>
                    </li> 
                        ...
                        <div class="row">
                            <div class="col-md-12 mt-lg-4 mt-4">
                                ...
                                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                                    <h1 class="h3 mb-0 light">Verify Loan</h1>
                                                        ...
                                                        <table id="EditTable" class="table v-middle" style="margin-top: 30px;">
                                                            <thead class="thead-light">
                                                                <tr>
                                                                    ...
                                                                    <th scope="col">Verify Loan</th>
                                                                    <th scope="col">Reject Loan</th>
                                                            ...
                                                            <tbody class="dark_bg">
                                                                ...
                                                                ?>
                                                                    <tr>
                                                                        ...
                                                                        <td class="light"><?php echo $row['Account_Number']; ?></td>

                                                                        <td class="light"><?php echo $Name; ?></td>

                                                                        <td class="light"><?php echo $row['email']; ?></td>

                                                                        <td class="light"><?php echo $row['Mobile_Number']; ?></td>

                                                                        <td class="light"><?php echo $row['addres']; ?></td>
                                                                ...
                                                                ?>
                                                                <h1 class="light" style="text-align: center;">No Loan for Verification</h1>
                    ...
                    <div class="container-fluid">
                        <div class="row text-muted">
                            <div class="col-6 text-left">
                                <p class="mb-0">
                                    <a href="../index.php" class="text-muted light"><strong>ASAP Bank
                                        </strong></a> &copy
                                </p>
                            </div>
