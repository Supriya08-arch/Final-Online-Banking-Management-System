...
127.0.0.1/ASAP Bank/customer_detail/		http://localhost/phpmyadmin/tbl_sql.php?db=ASAP Bank&table=customer_detail
...
<head>
    ...
    <title>Dashboard ASAP Bank</title>
        ...
        <nav class="fixed-top align-top" id="sidebar-wrapper" role="navigation">
            <div class="simplebar-content" style="padding: 0px;">
                ...
                <ul class="navbar-nav align-self-stretch">
                    ...
                    <li class="menuHover box-icon">
                        <a href="../admin/VerifyLoan.php" class="nav-link text-left" role="button">
                            <i class="flaticon-bar-chart-1"></i> <i class="bx bx-check-circle ico"></i> Verify loan <span class="badge badge-success" style="font-size: 12px; margin-left: 50px;"> <?php echo $count; ?> new</span>
                        </a>
                    </li>
