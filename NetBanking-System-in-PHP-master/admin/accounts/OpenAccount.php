...
127.0.0.1/ASAPbank/customer_detail/		http://localhost/phpmyadmin/tbl_sql.php?db=ASAPbank&table=customer_detail
...
<head>
    ...
    <title>ASAP Bank Dashboard</title>
        ...
        <nav class="fixed-top align-top" id="sidebar-wrapper" role="navigation">
            <div class="simplebar-content" style="padding: 0px;">
                <a class="sidebar-brand" href="#">
                    <span class="align-middle">ASAP BANK</span>
                </a>
                                                ...
                                                <form id="regForm" action="<?php htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST" enctype="multipart/form-data">
                                                        ...
                                                        <div class="row g-2 mb-3">
                                                            ...
                                                            <div class="col-md">
                                                                <div class="col-md mb-3">
                                                                    ...
                                                                    <input name="CitizenNumber" class="form-control dark_bg light" type="tel" id="CitizenNo" pattern="[0-9]{12}" placeholder="Citizen Number" onkeypress="return isNumber(event)">

                                                                    <span id="CitizenError" style="color: red;"><?php if (isset($_POST['submit'])) {
                                                                                                                    echo $Citizen_Number_error;
                                                                                                                } ?></span>
                                                    ...
                                                    <div class="tab mb-3" id="KycTab">
                                                        ...
                                                        <div class="form-groupmb-3" style="align-items: center; justify-content:center;">
                                                            <label for="exampleFormControlFile1">Upload Citizen Card</label>
                                                            <input type="file" name="CitizenCardUp" class="form-control-file" id="CitizenCardUp" size="30" accept="image/jpg,image/png,image/jpeg,image/gif">
                                                            <span id="CitizenUpError" style="color: red;"><?php if (isset($_POST['submit'])) {
                                                                                                            echo $Citizen_Up_error;
                                                                                                        } ?></span>
                                                        </div>
                    ...
                    <div class="container-fluid">
                        <div class="row text-muted">
                            <div class="col-6 text-left">
                                <p class="mb-0">
                                    <a href="index.html" class="text-muted light"><strong>ASAP Bank
                                        </strong></a> &copy
                                </p>
                            </div>
