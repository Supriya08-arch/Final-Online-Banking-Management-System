...
<head>
    ...
    <title>Verify Account ASAP Bank</title>
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content gray_bg">
                ...
                <div class="modal-body light">
                    ...
                    <!-- KYC Document -->
                    <h6 style="margin-bottom: 30px;margin-top: 30px;border-bottom: 1px solid;display: table;"> Documents Uploaded: </h6>




                    <!-- Trigger the Modal -->
                    <img id="citizenImg" class="kycImg" alt="Adhar Card" style="width:100%;max-width:300px">
