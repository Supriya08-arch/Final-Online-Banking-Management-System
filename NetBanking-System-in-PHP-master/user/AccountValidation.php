<?php
    ...
    // Checking Citizen Number is set or not
    if (isset($_POST['CitizenNumber'])) {
        
        /* storing Citizen Number in varible using mysqli_real_escape_string function to remove special charaters like double quotes or etc */
        $CitizenNo = mysqli_real_escape_string($conn, $_POST['CitizenNumber']);

        // sql query to check Citizen no is available or not
        $query = "SELECT * FROM customer_detail WHERE C_Citizen_No = '".$CitizenNo."'";
