                    ...
                    <div class="col-sm-8">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text pl-2 pr-2"> &emsp; Your virtual debit card verification is in progress after you successfully sent your debit card application to the bank. Within two to three days, the Debit Card will be available. </p>
                                <p class="card-text pl-2 pr-2">Thank You, </p>
                                <p class="card-text mb-4 pl-2 pr-2">ASAP Bank</p>
                                                    ...
                                                    <div class="card dcard-back">
                                                        <div class="card-body">
                                                            <div class="d-flex justify-content-between">
                                                                <h5 class="text-light">ASAP Bank</h5>
                                                ...
                                                <div id="OnCardToggle" class="card dcard-back">
                                                    <div class="card-body" style="padding: 0px;">
                                                        ...
                                                        <div style="padding-top: 10px;">
                                                            <p class="text-light dback-tittle">Call for customer service. 01-5544221</p>
                                                        </div>
                                                        ...
                                                        <div>
                                                            ...
                                                            <p class="description">This card is issued by ASAP Bank. The agreement, as revised, governs the use of this card. This card is the issuer's property, and it must be returned upon request, and it may be withdrawn at any time without warning.</p>
